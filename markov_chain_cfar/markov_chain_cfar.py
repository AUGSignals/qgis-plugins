...
from .markov_chain_cfar_dialog import MarkovChainCFARDialog
...
class MarkovChainCFAR:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'MarkovChainCFAR_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Markov Chain CFAR')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('MarkovChainCFAR', message)
    ...
    def addToCustomMenu(self):
        ...
        self.action.setObjectName("Markov Chain CFAR")
        self.action.setWhatsThis("Configuration for test plugin")
        self.action.setStatusTip("Markov Chain CFAR plugin")
    ...
    def initGui(self):
        ...
        """
        icon_path = ':/plugins/markov_chain_cfar/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
