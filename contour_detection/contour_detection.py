...
/***************************************************************************
 ContourDetection
                                 A QGIS plugin
 This plugin performs a contour detection.
...
from .contour_detection_dialog import ContourDetectionDialog
import os.path
...
class ContourDetection:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'ContourDetection_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Contour Detection')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ContourDetection', message)
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = ContourDetectionDialog()
        ...
        if result:
            ...
            self.arguments["-c"] = str(self.dlg.smallObjectCountSpinBox.text())
            self.arguments["-t"] = str(self.dlg.thresholdQgsDoubleSpinBox.text())
