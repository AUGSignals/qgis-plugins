...
class RefinedLeeFilter:
    ...
    def initGui(self):
        ...
        """
        icon_path = ':/plugins/refined_lee_filter/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
    ...
    def run(self):
        ...
        if result:
            ...
            self.arguments["-c"] = str(self.dlg.mcb_input.currentLayer().width())
            self.arguments["-r"] = str(self.dlg.mcb_input.currentLayer().height())
