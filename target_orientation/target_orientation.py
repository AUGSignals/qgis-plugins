...
from .target_orientation_dialog import TargetOrientationDialog
import os.path
...
class TargetOrientation:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'TargetOrientation_{}.qm'.format(locale))
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('TargetOrientation', message)
    ...
    def addToCustomMenu(self):
        ...
        self.action = QAction(QIcon(":/plugins/target_orientation/icon.png"),
                                    "Target Orientation",
                                    self.iface.mainWindow())
        self.action.setObjectName("Target Orientation")
        ...
        for item in self.menu.actions():
            if item.text() == '&Target Orientation':
        ...
        if not submenus:
            self.subMenu = self.menu.addMenu( '&Target Orientation')

        self.subMenu.setObjectName("&Target Orientation")
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = TargetOrientationDialog()
