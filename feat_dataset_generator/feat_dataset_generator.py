...
from .feat_dataset_generator_dialog import FeatDatasetGeneratorDialog
...
class FeatDatasetGenerator:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'FeatDatasetGenerator_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Feature Dataset Generator')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('FeatDatasetGenerator', message)
    ...
    def addToCustomMenu(self):
        ...
        self.action.setObjectName("Feature Dataset Generator")
        ...
        if not submenus:
            self.subMenu = self.menu.addMenu( '&Classification')

        self.subMenu.setObjectName("&Classification")
    ...
    def initGui(self):
        ...
        """
        icon_path = ':/plugins/feat_dataset_generator/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Feature Dataset Generator'),
                action)
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = FeatDatasetGeneratorDialog()
        ...
        if result:
            ...
            exeName = "FeatDatasetGeneration.exe"
            path = path + "/" + exeName
            args.insert(0, path)
