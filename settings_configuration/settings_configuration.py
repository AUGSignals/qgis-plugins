...
class SettingsConfiguration:
    ...
    def openOutputPath(self):
        filepath = str(QFileDialog.getExistingDirectory(self.dlg, "Select Directory"))
        if filepath:
            self.dlg.le_output_2.setText(filepath)
    ...
    def run(self):
        ...
        self.dlg.le_output_2.setText(path)
        ...
        if result:
            ...
            s.setValue("qgis-exe/path", self.dlg.le_output_2.text())
