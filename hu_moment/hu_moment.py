...
from .hu_moment_dialog import HuMomentsDialog
import os.path
...
class HuMoments:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Hu Moments')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('HuMoments', message)
    ...
    def initGui(self):
        ...
        """
        icon_path = ':/plugins/hu_moment/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
    ...
    def run(self):
        ...
        if result:
            ...
            self.arguments["-n"] = self.dlg.le_numBins.text()
            ...
            for key, value in self.arguments.items():
                if (value == None):
                    ...
                    args.append(key)
                    args.append(value)
            args.insert(0, "C:\\Users\\TomasBL\\Documents\\AUG\\bin\\HuMoments.exe")
