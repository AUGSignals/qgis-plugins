...
from .model_based_cfar_dialog import ModelBasedCFARDialog
import os.path
...
class ModelBasedCFAR:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'ModelBasedCFAR_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Model Based CFAR')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ModelBasedCFAR', message)
    ...
    def run(self):
        ...
        if result:
            ...
            self.arguments["-k"] = str(self.dlg.backgroundWindowQDoubleSpinBox.text())
