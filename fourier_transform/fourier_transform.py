...
from .fourier_transform_dialog import FourierTransformDialog
import os.path
...
class FourierTransform:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'FourierTransform_{}.qm'.format(locale))
        ...
        if not self.menu:
            self.menu = self.tr(u'&Fourier Transform')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('FourierTransform', message)
    ...
    def initGui(self):
        ...
        """
        icon_path = ':/plugins/lee_sigma_filter/icon.png'
