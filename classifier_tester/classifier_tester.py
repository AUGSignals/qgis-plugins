...
/***************************************************************************
 ClassifierTester
                                 A QGIS plugin
 This plugin launches the classifier testing process.
...
class ClassifierTester:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'ClassifierTester_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Classifier Tester')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ClassifierTester', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/classifier_tester/icon.png'
