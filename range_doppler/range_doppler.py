...
class RangeDopplerTerrainCorrection:
    ...
    def run(self):
        ...
        if result:
            ...
            args = ["java -jar RS2ProductMetadata.jar","../TestData/RS2_OK66194_PK606152_DK544088_FQ3W_20150808_103527_HH_VV_HV_VH_SLC.zip","output","HH"]
            ...
            print(output)
            #java -jar "RS2ProductMetadata.jar" "../TestData/RS2_OK66194_PK606152_DK544088_FQ3W_20150808_103527_HH_VV_HV_VH_SLC.zip" "output" "HH"
