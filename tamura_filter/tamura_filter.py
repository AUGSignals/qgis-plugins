...
from .tamura_filter_dialog import TamuraFilterDialog
import os.path
...
class TamuraFilter:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'TamuraFilter_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Tamura Filter')
        ...
        if result:
            ...
            for key, value in self.arguments.items():
                if (value == None):
                    ...
                    args.append(key)
                    args.append(value)
            args.insert(0, "C:\\Users\\TomasBL\\Documents\\AUG\\bin\\TamuraFilter.exe")
