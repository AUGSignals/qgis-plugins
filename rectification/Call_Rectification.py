...
/***************************************************************************
 CallRectification
                                 A QGIS plugin
 This plugin is to call the rectification executable 
...
from .Call_Rectification_dialog import CallRectificationDialog
...
class CallRectification:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'CallRectification_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Call Rectification')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('CallRectification', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/Call_Rectification/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Call Rectification Executable'),
            callback=self.run,
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = CallRectificationDialog()
