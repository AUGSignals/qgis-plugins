...
from .rectification_dialog import RectificationDialog
...
class CallRectification:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'Rectification_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Rectification')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Rectification', message)
    ...
    def addToCustomMenu(self):
        ...
        self.action = QAction(QIcon(":/plugins/rectification/icon.png"),
                                    "Rectification",
