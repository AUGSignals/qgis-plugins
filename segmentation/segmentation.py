...
/***************************************************************************
 Segmentation
                                 A QGIS plugin
 This plugin launches a segmentation process
...
class Segmentation:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Segmentation')
    ...
    def run(self):
        ...
        self.dlg.cb_kernelsize.clear()
        self.dlg.cb_kernelsize.addItems(kernelsizes)
        ...
        if result:
            ...
            for key, value in self.arguments.items():
                if (value == None):
                    ...
                    args.append(key)
                    args.append(value)
            args.insert(0, "C:\\Users\\TomasBL\\Documents\\AUG\\bin\\Segmentation.exe")
