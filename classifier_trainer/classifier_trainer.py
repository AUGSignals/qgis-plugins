...
from .classifier_trainer_dialog import ClassifierTrainerDialog
...
class ClassifierTrainer:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'ClassifierTrainer_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Classifier Trainer')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ClassifierTrainer', message)
    ...
    def addToCustomMenu(self):
        ...
        self.action = QAction(QIcon(":/plugins/classifier_trainer/icon.png"),
                                    "Classifier Trainer",
