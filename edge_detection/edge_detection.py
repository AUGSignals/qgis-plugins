...
class EdgeDetection:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'EdgeDetection_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Edge Detector')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('EdgeDetection', message)
    ...
    def initGui(self):
        ...
        """
        icon_path = ':/plugins/edge_detection/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
    ...
    def run(self):
        ...
        if result:
            ...
            self.arguments["-a"] = self.dlg.le_aperture.text()
            ...
            for key, value in self.arguments.items():
                if (value == None):
                    ...
                    args.append(key)
                    args.append(value)
            args.insert(0, "C:\\Users\\TomasBL\\Documents\\AUG\\bin\\EdgeDetection.exe")
