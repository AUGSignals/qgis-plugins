...
/***************************************************************************
 TargetSegmentation
                                 A QGIS plugin
 This plugin performs target segmentation
...
from .target_segmentation_dialog import TargetSegmentationDialog
import os.path
...
class TargetSegmentation:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'TargetSegmentation_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Target Segmentation')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('TargetSegmentation', message)
    ...
    def addToCustomMenu(self):
        ...
        self.action.setObjectName("Target Segmentation")
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = TargetSegmentationDialog()
        ...
        if result:
            ...
            self.arguments['-n'] = str(self.dlg.minorAxisSpinBox.text())
            self.arguments['-s'] = str(self.dlg.morphShapeComboBox.currentIndex())
