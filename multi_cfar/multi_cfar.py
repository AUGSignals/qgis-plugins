...
from .multi_cfar_dialog import MultiCFARDialog
import os.path
...
class MultiCFAR:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Multi CFAR')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('MultiCFAR', message)
